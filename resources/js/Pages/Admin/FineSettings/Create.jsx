          ...
          <form className="space-y-6" onSubmit={onHandleSubmit}>
            <div className="grid w-full items-center gap-1 5">
              ...
              {errors.late_fee_per_day && (
                <InputError message={errors.late_fee_per_day} />
              )}
            </div>
            <div className="grid w-full items-center gap-1 5">
              ...
              <Input
                ...
                onChange={onHandleChange}
              />
              {errors.damage_fee_percentage && (
                <InputError message={errors.damage_fee_percentage} />
              )}
            </div>
            <div className="grid w-full items-center gap-1 5">
              ...
              <Input
                ...
                onChange={onHandleChange}
              />
              {errors.lost_fee_percentage && (
                <InputError message={errors.lost_fee_percentage} />
              )}
            </div>
