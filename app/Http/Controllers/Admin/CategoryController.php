...
class CategoryController extends Controller
{
    ...
    public function create(): Response
    {
        return inertia('Admin/Categories/Create', [
            'page_settings' => [
                ...
                'subtitle' => 'Tambahkan data kategori baru di sini. Klik simpan setelah selesai.',
                'method' => 'POST',
    ...
    public function edit(Category $category): Response
    {
        return inertia('Admin/Categories/Edit', [
            'page_settings' => [
                'title' => 'Edit Kategori',
                'subtitle' => 'Edit data kategori yang sudah ada di sini. Klik simpan setelah selesai.',
                'method' => 'PUT',
